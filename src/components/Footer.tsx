      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-5 pb-4">
        <div className="flex flex-col items-center justify-center gap-2 text-center">
          <img
            ...
            className="h-auto w-24 object-contain opacity-35 [filter:brightness(0)_saturate(100%)]"
          />
          <div className="flex flex-col items-center gap-1">
            <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-charcoal/40">
